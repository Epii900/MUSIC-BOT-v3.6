...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (!queue || !queue.playing) return interaction.reply({ content: '⚠️ Müzik oynatılamıyor!!', ephemeral: true }).catch(e => { })
...
try {
  ...
  if (!queue || !queue.playing) {
    return interaction.reply({ content: '⚠️ Müzik oynatılamıyor!!', ephemeral: true });
  }
